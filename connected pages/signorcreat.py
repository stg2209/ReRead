...
creat_acc_b= Button(win, text="Create account",width="10",font=("papyrus",15),command=creatacc).grid(row=9,column=6);
sign_in_b= Button(win, text="Sign in",font=("papyrus",15),command=sell_consu).grid(row=5,column=6)
