...
lb1= Label(base, text="Enter Name", width=10, font=("arial",12),bg='maroon')  
...
lb5= Label(base, text="Select Gender", width=15, font=("arial",12),bg='grey')  
lb5.place(x=5, y=240)  
vars = IntVar()  
...
Button(base, text="Register", width=10,bg='yellow').place(x=200,y=400)  
base.mainloop() 